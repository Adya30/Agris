<nav id="navbar" class="fixed w-full z-50 transition-all duration-500 px-6 bg-[#0f8629]/60 backdrop-blur-lg">
    <div class="max-w-7xl mx-auto">
        <div class="flex justify-between items-center h-17">
            <a href="<?php echo e(route('landing')); ?>" class="flex items-center gap-3 text-2xl font-bold text-white tracking-tight">
                <img src="<?php echo e(asset('images/icon.png')); ?>" class="w-10 h-auto drop-shadow-md" alt="Logo AGRIS">
                <span>AGRIS</span>
            </a>

            <div class="hidden md:flex items-center gap-10 font-semibold text-white">
                <a href="<?php echo e(route('landing')); ?>" class="relative group py-2 transition-colors duration-300">
                    Beranda
                    <span class="absolute left-0 -bottom-1 w-0 h-0.5 bg-[#10b981] transition-all duration-300 group-hover:w-full"></span>
                </a>
                <a href="<?php echo e(route('about')); ?>" class="relative group py-2 transition-colors duration-300">
                    Tentang
                    <span class="absolute left-0 -bottom-1 w-0 h-0.5 bg-[#10b981] transition-all duration-300 group-hover:w-full"></span>
                </a>
                <a href="<?php echo e(route('guest.blog.index')); ?>" class="relative group py-2 transition-colors duration-300">
                    Blog
                    <span class="absolute left-0 -bottom-1 w-0 h-0.5 bg-[#10b981] transition-all duration-300 group-hover:w-full"></span>
                </a>
                <a href="<?php echo e(route('contact')); ?>" class="relative group py-2 transition-colors duration-300">
                    Kontak
                    <span class="absolute left-0 -bottom-1 w-0 h-0.5 bg-[#10b981] transition-all duration-300 group-hover:w-full"></span>
                </a>
            </div>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-[#0B2B26] border-t border-white/10 absolute w-full left-0">
        <div class="px-6 pt-6 pb-12 space-y-5 font-medium text-gray-300">
            ...
            <div class="pt-6 grid grid-cols-2 gap-4">
                ...
                <a href="<?php echo e(route('register')); ?>" class="flex items-center justify-center py-3 rounded-xl bg-[#58CC02] text-white font-bold shadow-lg">
                    Daftar
                </a>
            </div>
        </div>
...
<?php /**PATH D:\project\Agris\resources\views/components/navbar.blade.php ENDPATH**/ ?>