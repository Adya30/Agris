<?php $__env->startSection('title', 'Edit Blog - AGRIS'); ?>
...
<div class="max-w-5xl mx-auto pt-4 pb-12">
    ...
    <form action="<?php echo e(route('admin.blog.update', $blog->id)); ?>" method="POST" enctype="multipart/form-data" id="formBlog">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="relative cursor-pointer group">
                            <div id="imageContainer" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <img id="previewImg" src="<?php echo e($blog->fotoBlog ? asset('storage/' . $blog->fotoBlog) : '#'); ?>"
                                    class="w-full h-full object-cover <?php echo e($blog->fotoBlog ? '' : 'hidden'); ?>">
                                <div id="placeholderIcon" class="text-center text-gray-300 group-hover:text-gray-400 <?php echo e($blog->fotoBlog ? 'hidden' : ''); ?>">
                ...
                <div class="lg:w-2/3 p-8">
                    <div class="grid grid-cols-1 gap-5">
                        <div>
                            ...
                            <input type="text" name="judulBlog" value="<?php echo e(old('judulBlog', $blog->judulBlog)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="isiBlog" id="editor" rows="10"
                                ...
                                placeholder="Tuliskan isi blog..."><?php echo e(old('isiBlog', $blog->isiBlog)); ?></textarea>
                        ...
                        <div class="bg-gray-50 p-4 rounded-xl flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-bold text-gray-700"><?php echo e($blog->updated_at->format('d F Y')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'modalKonfirmasiBlog','title' => 'Konfirmasi','message' => 'Apakah yakin ingin mengubah blog?','confirmText' => 'Iya','cancelText' => 'Batal','confirmId' => 'btnSubmitForm','cancelId' => 'btnCloseModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modalKonfirmasiBlog','title' => 'Konfirmasi','message' => 'Apakah yakin ingin mengubah blog?','confirmText' => 'Iya','cancelText' => 'Batal','confirmId' => 'btnSubmitForm','cancelId' => 'btnCloseModal']); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project\Agris\resources\views/admin/blog/edit.blade.php ENDPATH**/ ?>