...
<section class="py-20 bg-gray-50 px-6">
    ...
    <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        <div class="text-center p-8 bg-white rounded-2xl shadow-sm border border-gray-100" data-aos="zoom-in">
            <div class="w-16 h-16 bg-green-50 rounded-2xl flex items-center justify-center text-[#58CC02] text-2xl mx-auto mb-5">
        ...
        <div class="text-center p-8 bg-white rounded-2xl shadow-sm border border-gray-100" data-aos="zoom-in" data-aos-delay="100">
            <div class="w-16 h-16 bg-green-50 rounded-2xl flex items-center justify-center text-[#58CC02] text-2xl mx-auto mb-5">
        ...
        <div class="text-center p-8 bg-white rounded-2xl shadow-sm border border-gray-100" data-aos="zoom-in" data-aos-delay="200">
            <div class="w-16 h-16 bg-green-50 rounded-2xl flex items-center justify-center text-[#58CC02] text-2xl mx-auto mb-5">
