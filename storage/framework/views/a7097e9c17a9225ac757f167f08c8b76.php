<?php $__env->startSection('title', 'Daftar Pengajuan Refund - Admin AGRIS'); ?>
...
<div class="max-w-7xl mx-auto pt-5 pb-12 px-4 sm:px-6">
    ...
    <div class="flex overflow-x-auto bg-white rounded-2xl border border-gray-200 p-1 mb-8 shadow-sm scrollbar-none">
        <a href="<?php echo e(route('admin.refund.index', ['status' => 'all'])); ?>" class="flex-1 text-center py-3 px-4 rounded-xl text-xs font-black transition-all whitespace-nowrap <?php echo e($status === 'all' ? 'bg-[#0f8629] text-white shadow-sm' : 'text-gray-500 hover:text-gray-800'); ?>">
            Semua
        </a>
        <a href="<?php echo e(route('admin.refund.index', ['status' => 'pending'])); ?>" class="flex-1 text-center py-3 px-4 rounded-xl text-xs font-black transition-all whitespace-nowrap <?php echo e($status === 'pending' ? 'bg-[#0f8629] text-white shadow-sm' : 'text-gray-500 hover:text-gray-800'); ?>">
            Pending
        </a>
        <a href="<?php echo e(route('admin.refund.index', ['status' => 'disetujui'])); ?>" class="flex-1 text-center py-3 px-4 rounded-xl text-xs font-black transition-all whitespace-nowrap <?php echo e($status === 'disetujui' ? 'bg-[#0f8629] text-white shadow-sm' : 'text-gray-500 hover:text-gray-800'); ?>">
            Disetujui
        </a>
        <a href="<?php echo e(route('admin.refund.index', ['status' => 'ditolak'])); ?>" class="flex-1 text-center py-3 px-4 rounded-xl text-xs font-black transition-all whitespace-nowrap <?php echo e($status === 'ditolak' ? 'bg-[#0f8629] text-white shadow-sm' : 'text-gray-500 hover:text-gray-800'); ?>">
            Ditolak
        </a>
    </div>
                        ...
                        <?php $__currentLoopData = $refunds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $refund): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50/50 transition">
                                ...
                                <td class="py-4 px-6 font-mono text-xs text-gray-600">
                                    #<?php echo e(substr($refund->pesananId, 0, 8)); ?>
                ...
                <div class="bg-white rounded-3xl border border-gray-200 shadow-sm p-5 space-y-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-[10px] text-gray-500 font-mono mt-0.5">Pesanan #<?php echo e(substr($refund->pesananId, 0, 8)); ?></p>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project\Agris\resources\views\admin\refund\index.blade.php ENDPATH**/ ?>