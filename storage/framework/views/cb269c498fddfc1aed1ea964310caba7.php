...
<div class="max-w-full mx-auto py-8">
    <div class="flex flex-col lg:flex-row gap-4 items-start">
        <div class="w-full lg:w-auto">
            <a href="<?php echo e(route('admin.produk.index')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 border-2 text-white bg-[#58CC02] rounded-2xl transition-all duration-300 font-bold group">
