...
<div class="max-w-7xl mx-auto pb-10 px-4">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        <div class="group bg-white rounded-3xl border border-gray-100 p-3 md:p-5 shadow-sm hover:shadow-md transition flex flex-col h-full relative">
            <a href="<?php echo e(route('agen.produk.show', $item->id)); ?>" class="relative aspect-4/4 rounded-2xl overflow-hidden bg-gray-50 mb-4 flex items-center justify-center">
            ...
            <a href="<?php echo e(route('agen.produk.show', $item->id)); ?>" class="grow">
                <h3 class="font-bold text-gray-800 text-sm mb-2 line-clamp-2 leading-snug hover:text-[#58CC02] transition-colors"><?php echo e($item->namaProduk); ?></h3>
