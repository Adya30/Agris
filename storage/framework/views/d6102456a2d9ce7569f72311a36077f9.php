                    ...
                    <div class="w-full lg:w-3/4 space-y-4">
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="namaLengkap" value="<?php echo e(old('namaLengkap', $user->namaLengkap)); ?>" class="form-input editable w-full rounded-xl border-gray-200 bg-gray-50/50 py-2 px-3 text-sm disabled:text-black transition-all font-medium" disabled>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" class="form-input editable w-full rounded-xl border-gray-200 bg-gray-50/50 py-2 px-3 text-sm disabled:text-black transition-all font-medium" disabled>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Nomor Telepon</label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Provinsi</label>
                                ...
                                <div>
                                    <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Kabupaten</label>
                                ...
                                <div>
                                    <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Kecamatan</label>
                                ...
                                <div>
                                    <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Desa</label>
                            ...
                            <div>
                                <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Detail Alamat</label>
