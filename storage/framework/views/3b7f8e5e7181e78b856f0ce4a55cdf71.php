...
<div class="max-w-7xl mx-auto pt-5 pb-12 px-4 sm:px-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-8">
        ...
        <div class="bg-white rounded-3xl border <?php echo e($isProfit ? 'border-blue-100' : 'border-red-200'); ?> shadow-sm p-6 relative overflow-hidden">
            <div class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl <?php echo e($isProfit ? 'from-blue-50' : 'from-red-50'); ?> to-transparent rounded-bl-full pointer-events-none"></div>
            <div class="flex items-center justify-between mb-3">
            ...
            <div class="mt-3">
                <div class="flex items-center justify-between mb-1">
                    <span class="text-[9px] font-black text-gray-400 uppercase tracking-wider">Rasio Pengeluaran</span>
                    <span class="text-[9px] font-black <?php echo e($isProfit ? 'text-blue-600' : 'text-red-600'); ?>"><?php echo e($ratioBar); ?>%</span>
                </div>
                <div class="w-full bg-gray-100 rounded-full h-1.5 overflow-hidden">
                    <div class="h-full rounded-full transition-all duration-500 <?php echo e($ratioBar > 80 ? 'bg-red-400' : ($ratioBar > 50 ? 'bg-amber-400' : 'bg-blue-400')); ?>"
                         style="width: <?php echo e($ratioBar); ?>%"></div>
                </div>
                <span class="text-[9px] text-gray-400 font-semibold mt-1 block">Neto = <?php echo e($netoPercent); ?>% dari pemasukan</span>
            </div>
        </div>
