...
<div class="max-w-6xl mx-auto pt-5 pb-12">
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-[10px] md:text-xs text-gray-500 font-mono font-bold mt-1">Nomor Pesanan: <?php echo e($pesanan->id); ?></p>
        </div>
        <div>
            ...
            <div class="bg-white p-4 md:p-6 rounded-3xl border border-gray-150 shadow-sm space-y-6">
                <div class="flex items-center justify-between mb-2 pb-4 border-b border-gray-100">
                    ...
                    <?php if(!empty($trackId) && !str_contains(strtoupper($trackId), 'AMBIL')): ?>
                        <a href="https://track.biteship.com/<?php echo e($trackId); ?>" target="_blank" class="inline-flex items-center gap-1.5 bg-blue-50 border border-blue-100 px-3 py-1 rounded-lg text-blue-650 font-bold text-[10px] hover:bg-blue-100 transition">
                ...
                <div class="relative pl-8 space-y-8 border-l-2 border-gray-100 ml-4 py-2">
                    ...
                    <?php if($isPickup): ?>
                        ...
                        <div class="relative">
                            ...
                            <div>
                                <div class="flex items-center gap-2 flex-wrap">
                                    <h3 class="text-sm font-extrabold <?php echo e($stage1Status !== 'waiting' ? 'text-gray-800' : 'text-gray-400'); ?>">Pesanan Dikemas</h3>
                                    <?php if($stage1Status === 'completed'): ?>
                                ...
                                <?php if($stage1Time): ?>
                                    <span class="inline-block text-[10px] font-bold text-gray-400 mt-1 bg-gray-50 px-2 py-0.5 rounded"><?php echo e($stage1Time); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <div>
                                <div class="flex items-center gap-2 flex-wrap">
                                    <h3 class="text-sm font-extrabold <?php echo e($stage2Status !== 'waiting' ? 'text-gray-800' : 'text-gray-400'); ?>">Siap Diambil</h3>
                                    <?php if($stage2Status === 'completed'): ?>
                                        <span class="bg-green-50 text-[#0f8629] border border-green-200 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider">Selesai</span>
                                    <?php elseif($stage2Status === 'active'): ?>
                                        <span class="bg-blue-50 text-blue-700 border border-blue-200 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider animate-pulse">Aktif</span>
                                ...
                                <?php if($stage2Time): ?>
                                    <span class="inline-block text-[10px] font-bold text-gray-400 mt-1 bg-gray-50 px-2 py-0.5 rounded"><?php echo e($stage2Time); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <div>
                                <div class="flex items-center gap-2 flex-wrap">
                                    <h3 class="text-sm font-extrabold <?php echo e($stage3Status !== 'waiting' ? 'text-gray-800' : 'text-gray-400'); ?>">Selesai Diambil</h3>
                                    <?php if($stage3Status === 'completed'): ?>
                                        <span class="bg-green-50 text-[#0f8629] border border-green-200 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider">Selesai</span>
                                    <?php else: ?>
                                        <span class="bg-gray-100 text-gray-500 border border-gray-200 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider">Menunggu</span>
                                ...
                                <?php if($stage3Time): ?>
                                    <span class="inline-block text-[10px] font-bold text-gray-400 mt-1 bg-gray-50 px-2 py-0.5 rounded"><?php echo e($stage3Time); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php else: ?>
                        ...
                        <div class="relative">
                            ...
                            <div>
                                <div class="flex items-center gap-2 flex-wrap">
                                    <h3 class="text-sm font-extrabold <?php echo e($stage1Status !== 'waiting' ? 'text-gray-800' : 'text-gray-400'); ?>">Penjemputan (Pickup)</h3>
                                    <?php if($stage1Status === 'completed'): ?>
                                        <span class="bg-green-50 text-[#0f8629] border border-green-200 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider">Selesai</span>
                                    <?php elseif($stage1Status === 'active'): ?>
                                        <span class="bg-blue-50 text-blue-700 border border-blue-200 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider animate-pulse">Aktif</span>
                        ...
                        <div class="relative">
                            ...
                            <div>
                                <div class="flex items-center gap-2 flex-wrap">
                                    <h3 class="text-sm font-extrabold <?php echo e($stage2Status !== 'waiting' ? 'text-gray-800' : 'text-gray-400'); ?>">Dalam Pengiriman</h3>
                                    <?php if($stage2Status === 'completed'): ?>
                                        <span class="bg-green-50 text-[#0f8629] border border-green-200 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider">Selesai</span>
                                    <?php elseif($stage2Status === 'active'): ?>
                                        <span class="bg-blue-50 text-blue-700 border border-blue-200 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider animate-pulse">Aktif</span>
                        ...
                        <div class="relative">
                            ...
                            <div>
                                <div class="flex items-center gap-2 flex-wrap">
                                    <h3 class="text-sm font-extrabold <?php echo e($stage3Status !== 'waiting' ? 'text-gray-800' : 'text-gray-400'); ?>">Diterima</h3>
                                    <?php if($stage3Status === 'completed'): ?>
                                        <span class="bg-green-50 text-[#0f8629] border border-green-200 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider">Selesai</span>
                                    <?php else: ?>
                                        <span class="bg-gray-100 text-gray-500 border border-gray-200 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider">Menunggu</span>
