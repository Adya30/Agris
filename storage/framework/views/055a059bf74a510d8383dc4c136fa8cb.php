...
<div class="max-w-4xl mx-auto pt-5 pb-12 px-6">
    ...
    <div class="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm mb-12">
        <div class="relative flex items-center justify-between mb-12">
            ...
            <div class="absolute left-0 top-1/2 -translate-y-1/2 h-1 <?php echo e($isFailed ? 'bg-red-500' : 'bg-[#58CC02]'); ?> z-0" style="width: <?php echo e($isFailed ? '100' : ($currentStep - 1) * 50); ?>%"></div>
            ...
            <div class="relative z-10 flex flex-col items-center">
                <div class="w-10 h-10 rounded-full flex items-center justify-center font-bold <?php echo e($currentStep > $index ? 'bg-[#58CC02] text-white' : ($currentStep == $index + 1 ? 'bg-white border-4 border-[#58CC02] text-[#58CC02]' : 'bg-white border-4 border-gray-100 text-gray-300')); ?>">
                    <?php if($currentStep > $index + 1): ?>
                        <i class="fa-solid fa-check"></i>
                    <?php elseif($isFailed && $index + 1 >= $currentStep): ?>
                ...
                <span class="absolute top-12 text-[10px] font-bold uppercase tracking-wider whitespace-nowrap <?php echo e($currentStep >= $index + 1 ? 'text-[#58CC02]' : 'text-gray-400'); ?>"><?php echo e($label); ?></span>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="md:col-span-2">
            <form id="formUploadMou" action="<?php echo e(route('kemitraan.store')); ?>" method="POST" enctype="multipart/form-data" class="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
                <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'uploadModal','title' => 'Konfirmasi','message' => 'Yakin untuk mengajukan kemitraan?','confirmText' => 'Iya','cancelText' => 'Batal','confirmId' => 'btnFinalSubmit','cancelId' => 'btnCancelUpload']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'uploadModal','title' => 'Konfirmasi','message' => 'Yakin untuk mengajukan kemitraan?','confirmText' => 'Iya','cancelText' => 'Batal','confirmId' => 'btnFinalSubmit','cancelId' => 'btnCancelUpload']); ?>
...
<?php echo $__env->make('layouts.agen', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project\Agris\resources\views\agen\kemitraan\create.blade.php ENDPATH**/ ?>