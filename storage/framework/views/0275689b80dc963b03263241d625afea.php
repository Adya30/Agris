...
<div class="max-w-7xl mx-auto pt-4 pb-12 px-4">
    <div class="mb-8 md:mb-10">
        <h1 class="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">Blog Kami</h1>
        <p class="text-gray-500 text-xs md:text-sm font-medium mt-1">Temukan informasi terbaru seputar AGRIS</p>
    </div>
        ...
        <div class="group relative bg-white rounded-3xl overflow-hidden shadow-sm flex flex-col border border-gray-100 hover:shadow-lg hover:shadow-gray-200/40 transition-all duration-300">
            ...
            <div class="relative h-44 sm:h-48 md:h-52 w-full overflow-hidden">
                <?php if($blog->fotoBlog): ?>
                    <img src="<?php echo e($blog->fotoBlog); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                <?php else: ?>
