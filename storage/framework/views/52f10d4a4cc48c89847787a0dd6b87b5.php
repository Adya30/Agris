<?php $__env->startSection('title', 'Profil Agen - AGRIS'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-full mx-auto py-8">
    <div class="flex flex-col lg:flex-row gap-4 items-start">
        <form action="<?php echo e(route('agen.profile.update')); ?>" method="POST" enctype="multipart/form-data" id="formProfile" class="flex-1 w-full">
            <?php echo csrf_field(); ?>
                ...
                <div class="p-10 flex flex-col lg:flex-row gap-16">
                    <div class="w-full lg:w-1/3 flex flex-col items-center">
                        <div class="group relative w-64 h-64 rounded-full overflow-hidden shadow-xl bg-gray-50 border-4 border-white">
                            <img id="previewFoto" src="<?php echo e($user->fotoProfil ? asset($user->fotoProfil) : 'https://ui-avatars.com/api/?name='.urlencode($user->namaLengkap ?? 'User')); ?>" class="w-full h-full object-cover">
                    ...
                    <div class="w-full lg:w-2/3 space-y-8">
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" name="namaLengkap" value="<?php echo e(old('namaLengkap', $user->namaLengkap)); ?>" class="form-input editable w-full rounded-2xl border-gray-200 bg-gray-50/50 py-3 px-4 disabled:text-black transition-all font-medium" disabled>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div>
                                    ...
                                    <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" class="form-input editable w-full rounded-2xl border-gray-200 bg-gray-50/50 py-3 px-4 disabled:text-black transition-all font-medium" disabled>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="noTelp" value="<?php echo e(old('noTelp', $user->noTelp)); ?>" class="form-input editable w-full rounded-2xl border-gray-200 bg-gray-50/50 py-3 px-4 disabled:text-black transition-all font-medium" disabled>
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div>
                                    ...
                                    <select id="provinsi" name="provinsiId" data-old="<?php echo e($user->desa->kecamatan->kabupaten->provinsi->id ?? ''); ?>" class="hidden form-input editable w-full rounded-2xl border-[#58CC02] bg-white py-3 px-4 text-sm focus:ring-0">
                                ...
                                <div>
                                    ...
                                    <select id="kabupaten" name="kabupatenId" data-old="<?php echo e($user->desa->kecamatan->kabupaten->id ?? ''); ?>" class="hidden form-input editable w-full rounded-2xl border-[#58CC02] bg-white py-3 px-4 text-sm focus:ring-0">
                                ...
                                <div>
                                    ...
                                    <select id="kecamatan" name="kecamatanId" data-old="<?php echo e($user->desa->kecamatan->id ?? ''); ?>" class="hidden form-input editable w-full rounded-2xl border-[#58CC02] bg-white py-3 px-4 text-sm focus:ring-0">
                                ...
                                <div>
                                    ...
                                    <select id="desa" name="desaId" data-old="<?php echo e($user->desaId ?? ''); ?>" class="hidden form-input editable w-full rounded-2xl border-[#58CC02] bg-white py-3 px-4 text-sm focus:ring-0">
                            ...
                            <div>
                                ...
                                <textarea name="detailAlamat" class="form-input editable w-full rounded-2xl border-gray-200 bg-gray-50/50 py-3 px-4 disabled:text-black transition-all font-medium resize-none" rows="2" disabled><?php echo e(old('detailAlamat', $user->detailAlamat)); ?></textarea>
                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        <?php if($errors->any()): ?> activateEditMode(); <?php endif; ?>
...
<?php echo $__env->make('layouts.agen', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project\Agris\resources\views\agen\profile.blade.php ENDPATH**/ ?>