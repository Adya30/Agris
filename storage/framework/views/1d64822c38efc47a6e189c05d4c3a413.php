                        ...
                        <div class="flex items-center gap-3 md:gap-4 py-4 first:pt-0 last:pb-0">
                            ...
                            <div class="text-right shrink-0 flex items-center gap-3">
                                ...
                                <?php if($pesanan->status === 'selesai' && $maxQty > 0): ?>
                                    <a href="<?php echo e(route('agen.refund.create', ['pesananId' => $pesanan->id, 'detailPesananId' => $detail->id])); ?>"
    ...
    <div id="content-batalPesananModal" class="relative bg-white rounded-[2rem] p-7 max-w-sm w-full shadow-2xl border border-gray-100 transition-all duration-300 transform scale-95 opacity-0">
        ...
        <div class="bg-gray-50 rounded-2xl p-3.5 mb-6 space-y-1.5 text-xs">
            <div class="flex justify-between">
                ...
                <span class="font-mono font-bold text-gray-700">#<?php echo e(strtoupper(substr($pesanan->id, -8))); ?></span>
            </div>
            <div class="flex justify-between">
                <span class="text-gray-400 font-semibold">Total Tagihan</span>
                <span class="font-black text-gray-800">Rp <?php echo e(number_format($pesanan->total_harga, 0, ',', '.')); ?></span>
            </div>
            <div class="flex justify-between items-center">
