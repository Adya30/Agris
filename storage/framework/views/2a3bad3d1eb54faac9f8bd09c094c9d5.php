    ...
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center gap-2 mb-5">
            <div class="flex justify-between">
                <a href="<?php echo e(route('guest.blog.index')); ?>" class="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 hover:text-[#58CC02] bg-white shadow-sm transition-all">
        ...
        <div class="bg-white rounded-[48px] border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="p-12">
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h4 class="font-bold text-gray-900"><?php echo e($blog->user->name ?? $blog->user->username ?? 'Admin'); ?></h4>
