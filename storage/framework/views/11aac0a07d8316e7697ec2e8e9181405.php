...
<section class="relative pt-10 pb-20 bg-gray-50 px-6">
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <a href="<?php echo e(route('guest.blog.show', $blog->id)); ?>" class="group bg-white rounded-4xl overflow-hidden shadow-sm border border-gray-100 flex flex-col" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
