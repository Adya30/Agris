...
<?php $__env->startSection('title', 'Lacak Pesanan - AGRIS'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function doSearch(query) {
        ...
        fetch('<?php echo e(route("guest.track.search")); ?>', {
            method: 'POST',
            headers: {
    ...
    function renderResult(data) {
        ...
        if (data.biteship_order_id) {
            biteshipBtnContainer.innerHTML = `
                <a href="https://track.biteship.com/${data.biteship_order_id}" target="_blank" class="inline-flex items-center gap-1.5 bg-blue-50 border border-blue-100 px-3.5 py-2 rounded-xl text-blue-600 font-extrabold text-xs hover:bg-blue-100 transition shadow-xs">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project\Agris\resources\views/guest/track.blade.php ENDPATH**/ ?>