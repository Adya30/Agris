...
<nav class="<?php echo e($isChatRoute ? 'relative' : 'fixed top-0'); ?> w-full z-55 shadow-md border-b border-white/10 transition-all duration-300">
    <div class="bg-[#0f8629] py-3 px-4 md:px-6">
        <div class="max-w-7xl mx-auto flex justify-between items-center gap-4">
            <a href="<?php echo e(route('agen.produk.index')); ?>" class="flex items-center gap-2 shrink-0">
                <img src="<?php echo e(asset('images/icon.svg')); ?>" class="w-12 h-auto" alt="Logo AGRIS">
            ...
            <div class="flex-1 max-w-xl hidden md:block px-4">
                <form action="<?php echo e(route('agen.produk.index')); ?>" method="GET" class="relative flex items-center bg-green-600/40 rounded-full p-1 border border-white/10 group">
                    <input type="text" name="search" value="<?php echo e(request()->routeIs('agen.produk.*') ? request('search') : ''); ?>" placeholder="Cari Produk...." class="w-full bg-white rounded-full py-2 px-5 text-sm text-gray-700 focus:outline-none placeholder-gray-400 transition-all">
    ...
    <div id="mobileMenu" class="hidden md:hidden bg-white border-t border-gray-100 shadow-2xl absolute w-full left-0 max-h-[calc(100vh)] overflow-y-auto opacity-0 -translate-y-2 transition-all duration-200">
        <div class="px-6 py-6 space-y-4">
            ...
            <form action="<?php echo e(route('agen.produk.index')); ?>" method="GET" class="flex items-center gap-2 bg-gray-100 rounded-xl px-4 py-2.5 border border-gray-200">
                <i class="fa-solid fa-magnifying-glass text-gray-400 text-sm"></i>
                <input type="text" name="search" value="<?php echo e(request()->routeIs('agen.produk.*') ? request('search') : ''); ?>" placeholder="Cari Produk...." class="flex-1 bg-transparent text-sm text-gray-700 focus:outline-none placeholder-gray-400">
            </form>
