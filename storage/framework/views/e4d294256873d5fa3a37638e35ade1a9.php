    ...
    <div class="flex items-center justify-between h-full px-6">
        <div class="flex items-center gap-4">
            <a href="<?php echo e(route('admin.produk.index')); ?>" class="flex items-center gap-2">
                <img src="<?php echo e(asset('images/icon.png')); ?>" class="h-9 w-9 object-contain">
        ...
        <div class="flex items-center gap-2 md:gap-4">
            <a href="<?php echo e(route('admin.chat.index')); ?>" class="flex items-center justify-center w-10 h-10 rounded-full bg-green-600/70 text-white hover:bg-green-600/60 transition-all">
...
<?php /**PATH D:\project\Agris\resources\views\components\topbar-admin.blade.php ENDPATH**/ ?>