        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div data-aos="fade-up" data-aos-delay="100">
                ...
                <ul class="space-y-2 text-gray-400 text-sm">
                    <li><a href="{{ route('landing') }}" class="hover:text-[#58CC02] transition">Beranda</a></li>
            ...
            <div data-aos="fade-up" data-aos-delay="200">
                ...
                <ul class="space-y-3 text-gray-400 text-sm">
                    ...
                    <li class="flex items-center gap-2">
                        ...
                        <span>{{ $admin->noTelp ?? '+62 812 3456 7890' }}</span>
                    </li>
                    <li class="flex items-center gap-2">
                        <i class="fa-solid fa-envelope text-[#04a243]"></i>
                        <span>{{ $admin->email ?? 'support@agris.com' }}</span>
                    </li>
                </ul>
            ...
            <div data-aos="fade-up" data-aos-delay="300">
                ...
                @if($admin && !empty(trim($admin->detailAlamat)))
                    <iframe
