...
<div class="max-w-7xl mx-auto pt-5 pb-12 px-4 sm:px-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-3xl border border-gray-200 shadow-sm p-6 relative overflow-hidden">
            ...
            <span class="text-2xl font-black text-green-600 mt-2 block">Rp {{ number_format($totalPemasukan, 0, ',', '.') }}</span>
        </div>
        <div class="bg-white rounded-3xl border border-gray-200 shadow-sm p-6 relative overflow-hidden">
            ...
            <span class="text-2xl font-black text-red-600 mt-2 block">Rp {{ number_format($totalPengeluaran, 0, ',', '.') }}</span>
        </div>
        <div class="bg-white rounded-3xl border border-gray-200 shadow-sm p-6 relative overflow-hidden">
            ...
            <span class="text-2xl font-black text-gray-900 mt-2 block">Rp {{ number_format($saldoNeto, 0, ',', '.') }}</span>
        </div>
    </div>
