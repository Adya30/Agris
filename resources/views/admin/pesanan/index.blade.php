                            ...
                            <tr class="hover:bg-gray-50/50 transition">
                                ...
                                <td class="py-4 px-6">
                                    <div class="flex flex-col">
                                        <span>{{ $pesanan->user->namaLengkap ?? 'Dihapus' }}</span>
                                        <span class="text-xs text-gray-400 font-bold mt-0.5">{{ '@' . ($pesanan->user->username ?? 'user') }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="py-4 px-6 text-center">
                                    <a href="{{ route('admin.pesanan.show', $pesanan->id) }}" class="inline-block bg-[#58CC02] hover:bg-[#46a302] text-white px-4 py-2 rounded-xl text-xs font-black transition shadow-sm">
                                        Detail
                                    </a>
                                </td>
                            </tr>
