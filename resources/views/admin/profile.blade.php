...
<div class="max-w-6xl mx-auto py-10 px-4">
    {{-- Tombol Kembali & Notifikasi tetap sama --}}
    <div class="mb-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-10 flex flex-col lg:flex-row gap-16">
                ...
                <div class="w-full lg:w-1/3 flex flex-col items-center">
                    ...
                    <p id="infoFoto" class="hidden text-center pt-5 text-xs text-red-400 leading-relaxed">
                        Ukuran maksimal 2mb. <br> Format gambar harus jpeg, png, atau jpg.
                    </p>
