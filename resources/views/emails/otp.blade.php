                    ...
                    <tr>
                        <td style="background:white; border-radius:8px; padding:36px 32px;">
                            ...
                            <p style="margin:0 0 24px; font-size:14px; color:#666;">
                                Halo {{ $namaLengkap }}, berikut kode OTP untuk verifikasi akun AGRIS Anda:
                            </p>

                            <div style="background:#f7f7f7; border:1px solid #e0e0e0; border-radius:8px; padding:20px; text-align:center; margin:0 0 24px;">
                                <span style="font-size:32px; font-weight:700; letter-spacing:6px; color:#222; font-family:'Courier New', monospace;">{{ $otp }}</span>
                            </div>
