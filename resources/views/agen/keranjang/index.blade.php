                    ...
                    <tr class="keranjang-item border-b border-gray-100 last:border-b-0 hover:bg-gray-50/40 transition-colors"
                        ...
                        <td class="px-5 py-4">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <span class="jumlah-val font-bold text-gray-800 text-sm w-6 text-center">{{ $item->jumlah }}</span>
            ...
            <div class="keranjang-item p-4 flex gap-4 items-center"
                ...
                <div class="flex flex-col items-end gap-2">
                    ...
                    <div class="flex items-center gap-2 bg-gray-50 rounded-lg p-1">
                        <button onclick="triggerKurang('{{ $item->id }}')" class="w-6 h-6 bg-white rounded shadow-sm text-xs">-</button>
                        <span class="jumlah-val font-bold text-sm w-5 text-center">{{ $item->jumlah }}</span>
                        <button onclick="tambahJumlah('{{ $item->id }}')" class="w-6 h-6 bg-[#58CC02] text-white rounded shadow-sm text-xs">+</button>
                    </div>
                </div>
            </div>
            @endforeach
