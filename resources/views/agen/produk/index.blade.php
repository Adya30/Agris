                ...
                <div class="mt-auto">
                    ...
                    <form class="add-to-cart-form">
                        ...
                        <button type="button"
                            ...
                            class="w-full {{ $item->stok <= 0 ? 'bg-gray-300 cursor-not-allowed' : 'bg-[#58CC02] hover:bg-[#46A302]' }} text-white py-2 rounded-xl transition font-bold text-xs flex items-center justify-center gap-2 shadow-sm">
