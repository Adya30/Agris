                    ...
                    <div class="w-full lg:w-3/4 space-y-4">
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="namaLengkap" value="{{ old('namaLengkap', $user->namaLengkap) }}" class="form-input editable w-full rounded-xl border-gray-200 bg-gray-50/50 py-2 px-3 text-sm disabled:text-black transition-all font-medium" disabled>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="email" name="email" value="{{ old('email', $user->email) }}" class="form-input editable w-full rounded-xl border-gray-200 bg-gray-50/50 py-2 px-3 text-sm disabled:text-black transition-all font-medium" disabled>
